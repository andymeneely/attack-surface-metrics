...
class JavaCGLoaderTestCase(unittest.TestCase):
    def test_load_call_graph(self):
        ...
        expected_content = [
            'onCreateOptionsMenu com.example.kevin.helloandroid.MainActivity',
            ...
            (
                'button_salute_onClick com.example.kevin.helloandroid.MainActi'
                'vity'
            ),
            ...
            (
                'onOptionsItemSelected com.example.kevin.helloandroid.MainActi'
                'vity'
            ),
            'findViewById com.example.kevin.helloandroid.MainActivity',
            (
                'button_saluteWorld_onClick com.example.kevin.helloandroid.Mai'
                'nActivity'
            ),
        ...
        all_nodes_found = (
            all([n in nodes for n in expected_content]) and
