...
class CallGraphTestCase(unittest.TestCase):
    ...
    def test_entry_surface_metrics(self):
        ...
        expected_values.append({'node': 'greet_b', 'proximity': 0, 'surface_coupling': 0})
        expected_values.append({'node': 'printf', 'proximity': 2.5, 'surface_coupling': 2})
    ...
    def test_exit_surface_metrics(self):
        ...
        expected_values.append({'node': 'recursive_a', 'proximity': 0, 'surface_coupling': 0})
        expected_values.append({'node': 'greet', 'proximity': 0, 'surface_coupling': 0})
        expected_values.append({'node': 'new_Greeter', 'proximity': 1, 'surface_coupling': 2})
        expected_values.append({'node': 'GreeterSayHiTo', 'proximity': 0, 'surface_coupling': 0})
        expected_values.append({'node': 'GreeterSayHi', 'proximity': 0, 'surface_coupling': 0})
        expected_values.append({'node': 'malloc', 'proximity': None, 'surface_coupling': None})
        expected_values.append({'node': 'main', 'proximity': 0, 'surface_coupling': 0})
        expected_values.append({'node': 'addInt', 'proximity': None, 'surface_coupling': None})
        ...
        expected_values.append({'node': 'recursive_b', 'proximity': 0, 'surface_coupling': 0})
