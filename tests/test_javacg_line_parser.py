...
class JavaCGLineParserTestCase(unittest.TestCase):
    def test_get_function_name_caller(self):
        # Arrange
        test_line_parser = JavaCGLineParser.get_instance(
            'M:com.example.kevin.helloandroid.Greeter:sayHello'
        )
    ...
    def test_get_function_signature_caller(self):
        ...
        # Assert
        self.assertEqual(
            'com.example.kevin.helloandroid.Greeter', test_function_signature
        )

    def test_get_function_name_callee(self):
        # Arrange
        test_line_parser = JavaCGLineParser.get_instance(
            '(M)java.lang.StringBuilder:append'
        )
