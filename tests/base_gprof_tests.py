...
class BaseGprofTests(object):
    ...
    def test_get_degree(self):
        # Arrange
        expected = {
            Call('main', './src/helloworld.c', Environments.C): (6, 6),
            Call('GreeterSayHi', './src/helloworld.c', Environments.C): (1, 1),
            Call('new_Greeter', './src/helloworld.c', Environments.C): (1, 1),
    ...
    def test_get_fan(self):
        # Arrange
        expected = {
            Call('main', './src/helloworld.c', Environments.C): (0, 6),
            Call('GreeterSayHi', './src/helloworld.c', Environments.C): (1, 0),
            Call('new_Greeter', './src/helloworld.c', Environments.C): (1, 0),
